...
alias run-maria-platzi="sudo docker run --rm -d -p 3306:3306 --name mariadb-platzi -e MARIADB_USER=mariadb -e MARIADB_ROOT_PASSWORD=chroot -e MARIADB_PASSWORD=root mariadb:10.6.5-focal"
